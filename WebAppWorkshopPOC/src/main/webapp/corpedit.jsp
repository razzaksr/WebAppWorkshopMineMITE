		...
		<div class="col-sm-12 col-md-6 p-3 rounded border shadow">
			...
			<form class="form" action="corpupdate" method="post">
				<div class="form-group">
					...
					<input type="text" name="org" value="<%=com.getOrg() %>" class="form-control" placeholder="Corporate Name">
				</div>
				<div class="form-group">
					<label for="date">Company visiting Date</label>
					<input type="text" name="date" value="<%=com.getDate() %>" class="form-control" placeholder="Corporate Visiting date yyyy-mm-dd">
				</div>
				<div class="form-group">
					<label role="required">Company required count</label>
					<input type="text" name="required" value="<%=com.getRequired() %>" class="form-control" placeholder="Corporate REquired Count">
				</div>
				<div class="form-group">
					<label for="role">Company role for hiring</label>
					<input type="text" name="role" value="<%=com.getRole() %>" class="form-control" placeholder="Corporate reuired role">
				</div>
				<div class="form-group">
					<label for="salary">Company package</label>
					<input type="text" name="salary" value="<%=com.getSalary() %>" class="form-control" placeholder="PAckage offered">
				</div>
				<div class="form-group">
					<label for=taken>Company hired count</label>
					<input type="text" name="taken" value="<%=com.getTaken() %>" class="form-control" placeholder="PAckage offered">
				</div>
				<div class="row justify-content-around mt-4">
					<button class="col-lg-4 btn btn-outline-primary">Update</button>
                    <button class="col-lg-4 btn btn-outline-danger">Cancel</button>
				</div>
			</form>
		</div>
	</div>
